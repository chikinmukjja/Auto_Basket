...
JNIEXPORT jint JNICALL Java_android_webcrawler_osori_opencvhog_MainActivity_calcOpticalFlow(JNIEnv *, jobject, jlong, jlong);
JNIEXPORT jint JNICALL Java_android_webcrawler_osori_opencvhog_MainActivity_hogDetection(JNIEnv *, jobject, jlong);
...
JNIEXPORT jint JNICALL Java_android_webcrawler_osori_opencvhog_MainActivity_calcOpticalFlow(JNIEnv *, jobject, jlong prev, jlong curr)
{
...
JNIEXPORT jint JNICALL Java_android_webcrawler_osori_opencvhog_MainActivity_hogDetection(JNIEnv *, jobject, jlong curr)
{
    Mat& currImage   = *(Mat*)curr;
...
void goodFeaturesToTrack_Demo(Mat& prevImage, vector<Point2f>& prevPoints)
{
    ...
    double minDistance  = 3;		// 반환되는 코너 점들 사이의 최소거리
    int blockSize = 3;
